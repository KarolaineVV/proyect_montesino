...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 27-10-2022 a las 17:07:00
...
(1, 123456, 'Público en General', 32310231, 'S/D', 1),
(2, 123789, 'Angel Fontalvo', 33315155, 'Lima', 1),
(3, 123, 'Maria', 3000000, 'calles21', 0),
(4, 1232000, 'karol', 2147483647, 'Barrio 450', 1),
(5, 465789, 'Adrian', 304555132, 'Calle 21', 1),
(6, 231542, 'Dilia', 320545551, 'Calle 22F', 1);
...
(1, 2580, 'Ferreteriaadmin', 'Ferreteriaadmin', 32004145, 'naju@vidainformatico.com', 'Colombia-Bogotá', '1.18');
...
(1, 12307, '2022-10-26 08:15:24', 500000, '500000.00', 1),
(2, 12304, '2022-10-26 08:15:52', 50, '14500.00', 1);
...
(12303, '4563', 'Pera', 1, '1200.00', 100, 0),
(12304, '123125', 'Piña', 1, '16000.00', 250, 1),
(12312, '12355', 'Martillo', 2, '25000.00', 250, 1);
...
(2, 'Home Center', '252526', 315054241, 'Calle 21- Car 3', 1),
(3, 'YouHouse', '21342', 102135455, 'Calle 21 #4-45', 1);
...
(1, 'Ferreteriaadmin', 'Ferreteriaadmin@gmail.com', 'admin', '12345', 1),
(9, 'Brayan', 'brayan@gmail.com', 'brayan', '1230', 2);
...
--
ALTER TABLE `producto`
  MODIFY `codproducto` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12313;
