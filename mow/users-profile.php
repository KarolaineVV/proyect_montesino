    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active"><a herf="user-profile.php"> Perfil</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
            ...
            <div class="card-body pt-3">
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  ...
                  <p class="small fst-italic">BomBom Asesino</p>

                  <h5 class="card-title">Detalles del perfil</h5>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label ">Nombre Completo</div>
                    <div class="col-lg-9 col-md-8">Brayan Sanchez</div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Compañia</div>
                    <div class="col-lg-9 col-md-8">Space X</div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8">COLOMBIA-USA</div>
                  </div>
                  ...
                  <form>
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        ...
                        <div class="pt-2">
                          <a href="#" class="btn btn-primary btn-sm" title="Subir Nueva Foto De Perfil"><i class="bi bi-upload"></i></a>
                          <a href="#" class="btn btn-danger btn-sm" title="Eliminar Foto De Perfil"><i class="bi bi-trash"></i></a>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <textarea name="about" class="form-control" id="about" style="height: 100px">BomBom Asesino</textarea>
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      <label for="Twitter" class="col-md-4 col-lg-3 col-form-label">Twitter Perfil</label>
                      <div class="col-md-8 col-lg-9">
                    ...
                    <div class="row mb-3">
                      <label for="Facebook" class="col-md-4 col-lg-3 col-form-label">Facebook Perfil</label>
                      <div class="col-md-8 col-lg-9">
                    ...
                    <div class="row mb-3">
                      <label for="Instagram" class="col-md-4 col-lg-3 col-form-label">Instagram Perfil</label>
                      <div class="col-md-8 col-lg-9">
                        <input name="instagram" type="text" class="form-control" id="Instagram" value="https://instagram.com/brayan.s.sanchez">
                      </div>
                    </div>

                    <div class="row mb-3">
                      <label for="Linkedin" class="col-md-4 col-lg-3 col-form-label">Linkedin Perfil</label>
                      <div class="col-md-8 col-lg-9">
                ...
                <div class="tab-pane fade pt-3" id="profile-change-password">
                  ...
                  <form>
                    ...
                    <div class="text-center">
                      <button onclick="Mostrar()" type="submit" class="btn btn-primary">Guardar Cambios</button>
